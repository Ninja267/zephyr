 ...
 * installs a callback that logs any threshold-crossing events,
 * and periodically polls get_events() from the main loop to drain
 * any events that may have been latched.
 */
