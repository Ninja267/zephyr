...
static inline const struct video_mcux_isi_core_data *video_mcux_isi_core_get_data(
...
#define VIDEO_MCUX_ISI_CORE_DEVICE(inst)							\
	...
	DEVICE_DT_INST_DEFINE(inst, video_mcux_isi_core_init, NULL,				\
			      ...
			      &video_mcux_isi_core_config_##inst, POST_KERNEL,			\
			      CONFIG_VIDEO_MCUX_ISI_CORE_INIT_PRIORITY, NULL);			\
