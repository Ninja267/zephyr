				...
				enum video_buf_type direction, uint16_t ind)
{
	...
	res_cap->width_min   = MCUX_PNGDEC_WIDTH_MIN;
	res_cap->width_max   = MCUX_PNGDEC_WIDTH_MAX;
	res_cap->width_step  = MCUX_PNGDEC_STEP;
	res_cap->height_min  = MCUX_PNGDEC_HEIGHT_MIN;
	res_cap->height_max  = MCUX_PNGDEC_HEIGHT_MAX;
	res_cap->height_step = MCUX_PNGDEC_STEP;
